  ...
  const onSubmit = async (data: any) => {
    ...
    try {
      await addDoc(collection(db, 'messages'), {
        name: data.name,
        email: data.contact, // Using 'contact' field as email for simplicity in this demo
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
            ...
            <div className="bg-white p-8 rounded-3xl card-shadow border border-accent/50 space-y-8">
              ...
              <div className="space-y-6">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <h4 className="font-bold text-ink">{t('contact.address')}</h4>
                    <p className="text-sm text-ink/60">{t('contact.addressText')}</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <h4 className="font-bold text-ink">{t('contact.phone')}</h4>
                    <p className="text-sm text-ink/60">{t('contact.phoneText')}</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <h4 className="font-bold text-ink">{t('contact.email')}</h4>
                    <p className="text-sm text-ink/60">{t('contact.emailText')}</p>
                  </div>
                </div>
              </div>
              ...
              <div className="h-48 bg-accent rounded-2xl overflow-hidden relative">
                <div className="absolute inset-0 flex items-center justify-center text-ink/30 font-bold">
          ...
          <div className="lg:col-span-2">
            <motion.div
              ...
              className="bg-white p-8 md:p-12 rounded-3xl card-shadow border border-accent/50"
            >
              <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
                ...
                <button
                  ...
                  className="w-full md:w-auto bg-primary hover:bg-primary/90 disabled:bg-primary/50 text-white font-bold px-12 py-4 rounded-xl transition-all flex items-center justify-center space-x-2 shadow-lg shadow-primary/20"
                >
